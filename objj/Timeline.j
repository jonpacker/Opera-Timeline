...
- (String) tweetHTMLWithName:(String)name text:(String)text icon:(String)icon {
  CPString tweet = [[CPString alloc] initWithString:tweetTemplate];
  return [tweet stringByReplacingOccurencesOfString:'
}
